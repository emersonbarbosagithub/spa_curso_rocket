...
class Turma extends Component {
    ...
    cadastraTurma(title, description, curso) {
        ...
        curso_selecionado.then(
            response => {
                return fetch('http://nameless-reaches-68184.herokuapp.com:3001/turmas/',{
                    method: "POST",
                    body: JSON.stringify({
                        title: title,
    ...
    pegaDadosCursoId(id) {
        return fetch('http://nameless-reaches-68184.herokuapp.com:3001/cursos/' + id)
    ...
    componentDidMount() {
        fetch('http://nameless-reaches-68184.herokuapp.com:3001/cursos/')
            .then(response => { return response.json(); })
            .then(data =>{
    ...
    pegaDadosAluno(id){
        ...
        return fetch('http://nameless-reaches-68184.herokuapp.com:3001/alunos/')
                .then(response => { return response.json(); })
                .then(data =>{
    ...
    pegaDados(id) {
        ...
        if (id === undefined) {
            ...
            return fetch('http://nameless-reaches-68184.herokuapp.com:3001/turmas/' + id)
                .then(response => { return response.json(); })
                .then(data =>{
