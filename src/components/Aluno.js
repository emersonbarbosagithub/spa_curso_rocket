...
class aluno extends Component {
    ...
    componentDidMount() {
        fetch(`https://nameless-reaches-68184.herokuapp.com:${process.env.PORT}/turmas/`)
    ...
    pegaDados(id) {
        if (id === undefined) {
            ...
            return fetch(`https://nameless-reaches-68184.herokuapp.com:${process.env.PORT}/alunos/` + id)
                .then(response => { return response.json(); })
                .then(data =>{
